...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "farazpatwegar75@gmail",
    href: "mailto:farazpatwegar@gmail.com",
  ...
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/faraz-patwegar/",
    content: "/patwegar-faraz",
    icon: <FaLinkedin height={"50px"} />,
  },
  {
    name: "GitHub",
    href: "https://github.com/farazpatwegar",
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10 text-roboto">
              Hey there! I&apos;m Faraz , a Comp. Sci. Engineer with 1.5 year experience in Devlopment, DevOps and 
